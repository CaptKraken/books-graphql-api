...
const Book = ({ book }) => {
  return (
    <Link href="/login">
      <a>
        <div className="mr-1 hover:scale-105 transition-all rounded-md relative overflow-hidden">
          ...
          <div className="absolute bottom-1 w-full p-4 bg-gradient-to-t from-green-400 to-transparent h-40 flex flex-col justify-end md:rounded-b-md">
