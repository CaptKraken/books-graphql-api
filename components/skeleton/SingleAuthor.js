const SingleAuthor = () => {
  return (
    <div className="flex flex-col gap-4 animate-pulse">
      <div className="bg-indigo-100 p-2 rounded-md h-36 flex items-center gap-4 justify-center">
        ...
        <div className="flex flex-col gap-2">
          <p className="h-4 w-8 bg-indigo-300 rounded-md"></p>
          <p className="h-4 w-24 bg-indigo-300 rounded-md"></p>
          <div className="bg-indigo-300 w-14 h-4 rounded-md"></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            className="w-full flex gap-4 rounded-md overflow-hidden items-center relative border-2 col-span-2 lg:col-span-1 flex-row"
            key={i}
          >
            <div className="bg-indigo-300 h-52 w-4/12 md:w-6/12 lg:w-4/12 ms:h-62 md:h-72" />
            ...
            <div className="hidden xs:block absolute bottom-0 right-0">
